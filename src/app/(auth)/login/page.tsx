  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
      <div className="text-center mb-8">
        ...
        <h1 className="text-2xl font-display font-bold text-charcoal">Welcome Back</h1>
      ...
      <div className="relative my-6">
        ...
        <div className="relative flex justify-center text-sm">
          <span className="px-3 bg-cream text-gray-400">or continue with</span>
        </div>
      </div>

      <Button type="button" variant="outline" className="w-full" onClick={handleGoogleLogin} icon={
