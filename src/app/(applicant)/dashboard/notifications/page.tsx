  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Button variant="ghost" size="sm" onClick={markAllRead} icon={<CheckCheck className="h-4 w-4" />}>
          Mark All Read
        </Button>
      </div>
        ...
        {notifications.length === 0 ? (
          ...
          notifications.map((n: any, i: number) => (
            <motion.div
              ...
              className={`bg-white rounded-xl border p-4 transition-colors ${n.is_read ? 'border-gray-100' : 'border-primary/20 bg-light-teal/30'}`}
            >
